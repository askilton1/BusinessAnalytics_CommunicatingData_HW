...
ggplot(AdData,aes(x=AdSpending,y=Sales,color=Market,alpha=0.75)) + 
  ...
  theme(legend.position="bottom",legend.title=element_blank(),
        axis.title=element_text(family="Times"),axis.text=element_text(family="Times"),legend.text=element_text(family="Times")) 
```
...
ggplot(AdData.melt,aes(x=value,y=Sales/1000,color=Market,alpha=0.75)) + 
  ...
  theme(legend.position="none",
        axis.title=element_text(family="Times"),axis.text=element_text(family="Times"),plot.title=element_text(family="Times")) + 
  stat_smooth() + 
