...
library(ggplot2)
ggplot(AdData.melt,aes(x=Market,y=value,color=variable)) +
  geom_boxplot() + 
...
library(ggplot2)
ggplot(AdData.melt,aes(x=value,y=Sales/1000,color=Market)) + 
  geom_point() + 
  ...
  xlab("Advertising Spending (in thousands of dollars)")
```
