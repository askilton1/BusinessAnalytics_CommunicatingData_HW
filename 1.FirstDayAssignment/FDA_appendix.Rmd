...
grid.arrange(plot_Sales,plot_Adspending,ncol=2,top=textGrob("Figure 1: Histograms of Sales and \nTotal Advertising Spending", gp=gpar(fontsize=10,fontfamily="Times")))
```
